...
```sh
curl -sL "artas90.github.io/pkgs/helix/helix-25.01-$(uname -m).tgz" | tar xz -C /opt && \
...
# podman run --rm --arch x86_64 -v .:/app -it ubuntu:20.04
# podman run --rm --arch aarch64 -v .:/app -it ubuntu:20.04
...
# cp "/tmp/app/$tarname.tgz" "/app/$tarname.tgz"
```
